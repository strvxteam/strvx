...
import { Plus, Trash2, X, Eye, Save, Send } from "lucide-react";
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg border border-[#e0e0e0] bg-white px-3 py-1.5 text-[13px] font-medium text-[#555] transition-colors hover:bg-[#f5f5f5]"
          >
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg border border-[#e0e0e0] bg-white px-3 py-1.5 text-[13px] font-medium text-[#555] transition-colors hover:bg-[#f5f5f5] disabled:opacity-40"
          >
          ...
          <button
            ...
            disabled={saving || sending}
            className="flex items-center gap-1.5 rounded-lg bg-[#111] px-3 py-1.5 text-[13px] font-medium text-white transition-colors hover:bg-[#333] disabled:opacity-40"
          >
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-[#f0f0f0] px-6 py-4">
          <h2 className="text-[15px] font-bold text-[#111]">Invoice Preview</h2>
          <button
            onClick={onClose}
        ...
        {/* Invoice content — mirrors the detail page layout */}
        <div className="p-6">
          <div className="rounded-lg border border-[#e0e0e0] bg-white p-6">
            {/* Branding header */}
            <div className="mb-6 flex items-start justify-between">
              <div>
                ...
                <p className="text-[13px] text-[#888]">hello@strvx.com</p>
              </div>
            ...
            <div className="mb-6 grid grid-cols-2 gap-6">
              <div>
                ...
                {clientEmail && (
                  <p className="text-[13px] text-[#888]">{clientEmail}</p>
                )}
              </div>
              <div className="text-right">
