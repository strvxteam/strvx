...
export const mockProjects: Project[] = [
  {
    ...
    timeEntries: [
      ...
      { id: "te-3", date: daysAgo(3).toISOString().split("T")[0], person: "Nick", hours: 4, description: "AI routing bug fixes", taskId: "task-4" },
      ...
      { id: "te-6", date: daysAgo(7).toISOString().split("T")[0], person: "Nick", hours: 7, description: "Real-time update system", taskId: null },
    ],
    timeline: [
      ...
      { id: "tl-8", type: "task", title: "AI task routing engine completed", description: null, date: daysAgo(15), person: "Nick" },
  ...
  },
  {
    ...
    timeEntries: [
      { id: "te-20", date: daysAgo(2).toISOString().split("T")[0], person: "Nick", hours: 5, description: "Payment webhook debugging", taskId: null },
      { id: "te-21", date: daysAgo(3).toISOString().split("T")[0], person: "Nick", hours: 3, description: "Analytics dashboard setup", taskId: null },
      { id: "te-22", date: daysAgo(5).toISOString().split("T")[0], person: "Nick", hours: 6, description: "Cart calculation fix", taskId: null },
    ],
    timeline: [
      ...
      { id: "tl-32", type: "task", title: "Product catalog & search completed", description: null, date: daysAgo(60), person: "Nick" },
      ...
      { id: "tl-35", type: "task", title: "Stripe payment integration completed", description: null, date: daysAgo(20), person: "Nick" },
  ...
  },
  {
    ...
    timeEntries: [
      { id: "te-30", date: daysAgo(1).toISOString().split("T")[0], person: "Nick", hours: 3, description: "Framework research & comparison", taskId: null },
    ],
    timeline: [
      { id: "tl-40", type: "system", title: "Project created", description: null, date: daysAgo(3), person: "Nick" },
      ...
      { id: "tl-42", type: "note", title: "Framework research started", description: "Comparing LangChain, LlamaIndex, and custom RAG pipeline", date: daysAgo(1), person: "Nick" },
    ],
  },
  {
    id: "proj-5",
